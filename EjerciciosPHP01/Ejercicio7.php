<!-- VERSION DONDE TODO ESTA GENERADO POR EL CLIENTE (Javascript)-->
<!DOCTYPE html>
<html>
...
<script>
    ...
    // Modifica la longitud de la tabla aleatoriamente
	function generar() {
		var nred   = random_int(50, 500);
		var ngreen = random_int(50, 500);
		var nblue  = random_int(50, 500);
		...
		// Se vuelve a llamar a los 2 segundos
		setTimeout(generar, 2000);
